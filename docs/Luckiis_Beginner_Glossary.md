...
```text
Foundations -> component library -> main components and variants
             -> instances on catalogue screen pages
             -> prototype links for visual review
